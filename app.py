...
const ToxicityManagementSystem = () => {
  ...
  // Órganos y toxicidades según ESMO
  const organSystems = {
    'Cutáneo': [
      'Rash maculopapular',
      'Prurito',
  ...
  const toxicityGrades = {
    ...
    'G3': {
      description: 'Síntomas severos o médicamente significativos; hospitalización posible; limita el autocuidado de la vida diaria',
  ...
  // Recomendaciones específicas por toxicidad y grado
  const getDetailedRecommendation = () => {
    const recommendations = {
      'Gastrointestinal': {
        'Diarrea/Colitis/Enterocolitis': {
          'G1': {
            ...
            ici: 'Continuar con monitorización'
          },
          'G2': {
            corticoid: 'Prednisona (Dacortin®) 40-60 mg/día VO',
            labValues: null,
            management: 'Si no mejora en 3-5 días: considerar infliximab o vedolizumab',
          ...
          'G3': {
            ...
            labValues: null,
            management: 'Hospitalización. Infliximab 5 mg/kg si corticorrefractario',
          ...
          'G4': {
            ...
            labValues: null,
            management: 'UCI. Infliximab precoz. Descartar megacolon/perforación',
      ...
      'Hepático': {
        'Hepatitis': {
          'G1': {
            ...
            management: 'Monitorización semanal. Descartar otras causas',
          ...
          'G3': {
            ...
            management: 'Hospitalización. Si no respuesta en 48-72h: MMF o Tocilizumab',
          ...
          'G4': {
            ...
            management: 'UCI. Considerar trasplante hepático si fallo fulminante',
      ...
      'Pancreático': {
        'Pancreatitis': {
          'G1': {
            ...
            management: 'Dieta normal. Monitorización',
          ...
          'G3': {
            ...
            management: 'Hospitalización. NPO. Fluidos IV. TC. Considerar CPRE',
          ...
          'G4': {
            ...
            management: 'UCI. Soporte hemodinámico. Considerar necrosectomía',
      ...
      'Renal': {
        'Nefritis intersticial aguda': {
          'G1': {
            ...
            management: 'Suspender nefrotóxicos. Monitorización',
            monitoring: 'Creatinina, iones cada 2-3 días',
            ici: 'Continuar con precaución'
          },
          'G2': {
            corticoid: 'Prednisona (Dacortin®) 1 mg/kg/día',
            labValues: 'Creatinina: 2-3× basal, o FG 25-50 ml/min (KDIGO 2)',
            management: 'Suspender nefrotóxicos. Considerar biopsia renal',
          ...
          'G4': {
            ...
            management: 'UCI. Diálisis urgente. Inmunosupresión 2ª línea precoz',
      ...
      'Pulmonar': {
        'Neumonitis': {
          'G1': {
            ...
            labValues: null,
            management: 'TC torácico. Descartar infección/progresión',
          ...
          'G2': {
            corticoid: 'Prednisona (Dacortin®) 1 mg/kg/día',
            labValues: null,
            management: 'TC torácico. Descartar infección',
          ...
          'G3': {
            corticoid: 'Metilprednisolona (Urbason®) 1-2 mg/kg/día IV',
            labValues: null,
            management: 'Hospitalización. Si no mejora: Tocilizumab o Infliximab',
          ...
          'G4': {
            corticoid: 'Metilprednisolona (Urbason®) 2 mg/kg/día IV',
            labValues: null,
            management: 'UCI. Ventilación mecánica. Inmunosupresión 2ª línea',
            monitoring: 'Gasometría. Rx/TC frecuente',
            ici: 'Suspender permanentemente',
            taper: 'Prolongado'
          }
        }
      ...
      'Hematológico': {
        'Anemia hemolítica autoinmune': {
          'G1': {
            ...
            management: 'Monitorización. Ácido fólico',
          ...
          'G2': {
            ...
            management: 'Test de Coombs. Transfusión si precisa',
          ...
          'G3': {
            ...
            management: 'IGIV 1 g/kg/día x 2. Rituximab si refractario',
            monitoring: 'Hemograma diario',
            ici: 'Suspender',
            taper: 'Prolongado'
          },
          'G4': {
            corticoid: 'Metilprednisolona (Urbason®) 2 mg/kg/día IV + IGIV',
            labValues: 'Hemoglobina: <6.5 g/dl, Compromiso vital',
            management: 'UCI. Transfusión urgente. IGIV + Rituximab',
        ...
        'Trombocitopenia': {
          ...
          'G3': {
            ...
            management: 'IGIV 1 g/kg/día x 2. Eltrombopag si refractario',
          ...
          'G4': {
            ...
            management: 'UCI. IGIV urgente. Transfusión plaquetaria',
      ...
      'Cardiovascular': {
        'Miocarditis': {
          'G2': {
            corticoid: 'Metilprednisolona (Urbason®) 500-1000 mg IV',
            labValues: 'Troponina elevada, ECG alterado',
            management: 'Hospitalización urgente. RM cardíaca. Monitorización',
            monitoring: 'Troponina, ECG, ecocardiografía',
            ici: 'Suspender inmediatamente',
            taper: '6-8 semanas'
          },
          'G3': {
            corticoid: 'Metilprednisolona (Urbason®) 1000 mg IV + IGIV',
            labValues: 'Troponina muy elevada, arritmias, FE reducida',
            management: 'UCI. IGIV. Infliximab o Abatacept si refractario',
            monitoring: 'Monitorización continua. Ecocardiografía diaria',
            ici: 'Suspender permanentemente',
            taper: '≥8 semanas'
          },
          'G4': {
            corticoid: 'Metilprednisolona (Urbason®) 1000 mg IV + inmunosupresión múltiple',
            labValues: 'Shock cardiogénico, arritmias mortales',
            management: 'UCI. Soporte inotrópico. ECMO si precisa',
            monitoring: 'Monitorización invasiva continua',
  ...
  const distributeDose = (totalMg) => {
    // Distribución: 50% desayuno, 35% comida, 15% cena
  ...
  const generatePDF = () => {
    ...
    if (!window.jspdf) {
      alert('Las librerías aún se están cargando. Espera unos segundos.');
      return;
    }
    ...
    try {
      ...
      doc.setFontSize(12);
      doc.setFont('helvetica', 'bold');
      doc.text('TRATAMIENTO PROFILÁCTICO (en caso de empleo de corticoides)', margin, yPos);
      yPos += 8;
      
      doc.setFontSize(10);
      doc.setFont('helvetica', 'normal');
      doc.text('• Omeprazol 20-40 mg/día durante TODO el tratamiento', margin, yPos);
      yPos += 6;
      doc.text('• Septrim Forte: Lunes-Miércoles-Viernes (si ≥20mg/día >4 semanas)', margin, yPos);
      yPos += 6;
      doc.text('• Calcio 1200 mg/día + Vitamina D 800-2000 UI/día', margin, yPos);
      yPos += 12;
      ...
      // Autoría DESPUÉS
      doc.setFont('helvetica', 'bold');
      doc.text('Elaborado con Claude, por Joaquín Gimeno.', pageWidth / 2, yPos, { align: 'center' });
      yPos += 5;
      doc.setFont('helvetica', 'normal');
  ...
  const generateWordDoc = () => {
    ...
    try {
      ...
      children.push(new Paragraph({ text: 'TRATAMIENTO PROFILÁCTICO (en caso de empleo de corticoides)', heading: 'Heading2' }));
      children.push(new Paragraph('• Omeprazol 20-40 mg/día durante TODO el tratamiento'));
      ...
      // Autoría DESPUÉS
      children.push(new Paragraph({
        children: [new TextRun({ text: 'Elaborado con Claude, por Joaquín Gimeno.', bold: true })],
        alignment: 1
      }));
            ...
            {!mode && (
              <div className="space-y-4">
                <Alert className="bg-blue-50 border-2 border-blue-300">
                  ...
                  <AlertDescription>
                    Selecciona el módulo que necesitas utilizar
                  </AlertDescription>
                </Alert>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    <div className="text-2xl font-bold mb-2">📋 Recomendaciones por Toxicidad</div>
                    <div className="text-sm opacity-90">
                      Consulta protocolos específicos según órgano, toxicidad y grado
                    </div>
                  </button>
                  ...
                  >
                    <div className="text-2xl font-bold mb-2">🧮 Calculadora de Descenso</div>
                    <div className="text-sm opacity-90">
                ...
                {selectedOrgan && (
                  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border-2 border-blue-300">
                    <label className="block font-semibold mb-2 text-blue-900">
                      🔬 Paso 2: Selecciona el tipo de toxicidad
                    </label>
                    <select
              ...
              <div className="space-y-4">
                ...
                <Alert className="bg-purple-50 border-2 border-purple-300">
                  ...
                  <AlertDescription>
                    ...
                    <p className="text-sm mt-1">Distribución óptima: 50% desayuno, 35% comida, 15% cena</p>
                  </AlertDescription>
                </Alert>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border-2 border-blue-300">
                  ...
                  {patientWeight && (
                    <div className="mt-3 space-y-1 text-sm bg-white p-3 rounded">
                      <p><strong>Dosis orientativas de Prednisona según peso:</strong></p>
                      <p>• 0.5 mg/kg = {(patientWeight * 0.5).toFixed(0)} mg/día (baja dosis)</p>
                      <p>• 1 mg/kg = {(patientWeight * 1).toFixed(0)} mg/día (dosis media)</p>
                      <p>• 2 mg/kg = {(patientWeight * 2).toFixed(0)} mg/día (dosis alta)</p>
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-4 rounded-lg border-2 border-orange-300">
                    <label className="block font-semibold mb-2">Reducción semanal (mg)</label>
                    <input
                      type="number"
                ...
                {taperSchedule && (
                  <div className="space-y-4">
                    <Alert className="bg-gradient-to-r from-blue-50 to-blue-100 border-2 border-blue-400">
                      <AlertDescription>
                        <div className="space-y-3">
                          <h3 className="font-bold text-lg text-blue-900">📅 Calendario de Descenso Calculado</h3>
                          ...
                          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border-2 border-blue-300 mt-4">
                            ...
                            {!librariesLoaded && (
                              <p className="text-xs text-orange-600 mb-3">
                                ⏳ Cargando librerías de generación...
                              </p>
                            )}
                    ...
                    <Alert className="bg-red-50 border-2 border-red-400">
                      <AlertDescription>
                        <div className="space-y-2">
                          <h4 className="font-bold text-red-900">⚠️ TRATAMIENTO PROFILÁCTICO OBLIGATORIO (en caso de empleo de corticoides):</h4>
                          <ul className="text-sm space-y-1 ml-4">
                            <li>• <strong>Omeprazol</strong> 20-40 mg/día en ayunas durante TODO el tratamiento</li>
                            <li>• <strong>Septrim Forte</strong> 1 comprimido: Lunes - Miércoles - Viernes (si prednisona ≥20 mg/día durante >4 semanas)</li>
                            <li>• <strong>Calcio</strong> 1200 mg/día + Vitamina D 800-2000 UI/día</li>
                          </ul>
                          <p className="text-sm font-bold text-red-900 mt-3">
                            ❌ NUNCA suspender bruscamente el tratamiento corticoideo
                          </p>
                        </div>
                      </AlertDescription>
                    </Alert>
